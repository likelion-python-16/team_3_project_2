    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cafe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='cafes.cafeif')),
            ],
        ),
        migrations.CreateModel(
            name='CafeTrendAI',
            fields=[
                ...
                ('rp_key', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trends', to='cafes.residentpopulation')),
            ],
        ),
        migrations.AddField(
            model_name='cafeif',
            name='rp_key',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cafes', to='cafes.residentpopulation'),
        ),
        migrations.CreateModel(
            name='CafeSales',
            fields=[
                ...
                ('cafe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='cafes.cafeif')),
            ],
            options={
                'indexes': [models.Index(fields=['cafe', 'date'], name='cafes_cafes_cafe_id_18d008_idx')],
            },
        ),
    ]
